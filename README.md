...
# Данный проект собирался больше для теста новой сборки gulp при поддержке MaxGraph. Все что нужно для написанного кода ниже находится в документации ниже.
